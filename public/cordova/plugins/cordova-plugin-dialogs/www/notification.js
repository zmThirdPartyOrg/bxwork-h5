 ...
 */
cordova.define(
  "cordova-plugin-dialogs.notification",
  function (require, exports, module) {
    ...
    module.exports = {
      ...
      alert: function (message, completeCallback, title, buttonLabel) {
        ...
        var _buttonLabel =
          buttonLabel && typeof buttonLabel === "string" ? buttonLabel : "OK";
        exec(completeCallback, null, "IBDialogsPlugin", "alert", [
          _message,
          _title,
          _buttonLabel,
        ]);
      ...
      confirm: function (message, resultCallback, title, buttonLabels) {
        ...
        exec(resultCallback, null, "IBDialogsPlugin", "confirm", [
          _message,
          _title,
          _buttonLabels,
        ]);
      ...
      prompt: function (
        ...
        exec(resultCallback, null, "IBDialogsPlugin", "prompt", [
          _message,
          _title,
          _buttonLabels,
          _defaultText,
      ...
      beep: function (count) {
        ...
        exec(null, null, "IBDialogsPlugin", "beep", [defaultedCount]);
      },
    };
